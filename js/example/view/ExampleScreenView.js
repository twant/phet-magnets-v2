...
define( function( require ) {
  ...
  function ExampleScreenView( model ) {
    ...
    // add or remove a node when the model's barMagnets ObservableArray is modified
    model.barMagnets.addItemAddedListener( addedMagnet => {
      var newMagnetNode = new BarMagnetNode( addedMagnet, modelViewTransform );
      this.addChild( newMagnetNode );
